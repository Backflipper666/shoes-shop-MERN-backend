...
const filePath1 = './imagesToUpload/adidas-vintage/adidas1.jpg';
const filePath2 = './imagesToUpload/adidas-vintage/adidas2.jpg';
const filePath3 = './imagesToUpload/adidas-vintage/adidas3.jpg';
const filePath4 = './imagesToUpload/adidas-vintage/adidas4.jpg';
...
db.once('open', async () => {
  const shoes = [
    {
      title: 'adidas TRX Vintage ',
      description: 'Really cool and good looking',
      brand: 'Adidas',
      price: 59000,
      color: 'blue',
      size: 42,
